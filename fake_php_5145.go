...
func (g FakePHP5145) TakeMachine(_ UserID) json.RawMessage {
	r := &response{
...
func (g FakePHP5145) OnLoadInfo(_ UserID) json.RawMessage {
...
func (g FakePHP5145) GetMachineDetail(UserID) json.RawMessage {
	r := &response{
...
func (g FakePHP5145) BeginGame(SessionID, BetInfo) json.RawMessage {
...
func (g FakePHP5145) CreditExchange(SessionID, BetBase, int) json.RawMessage {
	msg := `{"action":"onCreditExchange","result":{"data":{"Balance":99949999.99,"BetBase":"1:1","Credit":100,"event":true},"event":true}}`
	return json.RawMessage(msg)
}

func (g FakePHP5145) BalanceExchange(UserID, HallID) json.RawMessage {
...
func (g FakePHP5145) LeaveMachine(UserID, HallID) json.RawMessage {
	panic("implement me")
}

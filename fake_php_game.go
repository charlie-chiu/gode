...
func (g FakePhpGame) OnReady() []byte {
	r := &response{
		Action: "ready",
		Result: result{
			Event: true,
...
func (g FakePhpGame) OnLoadInfo() []byte {
...
func (g FakePhpGame) OnGetMachineDetail() []byte {
	r := &response{
...
func (g FakePhpGame) BeginGame() []byte {

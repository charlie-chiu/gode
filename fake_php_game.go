...
func (g FakePhpGame) OnLoadInfo(uid UserID, gc GameCode) json.RawMessage {
...
func (g FakePhpGame) OnGetMachineDetail(uid UserID, gc GameCode) json.RawMessage {
	r := &response{
...
func (g FakePhpGame) BeginGame(sid SessionID, gc GameCode, betInfo string) json.RawMessage {
...
func (g FakePhpGame) OnCreditExchange(sid SessionID, gc GameCode, bb string, credit int) json.RawMessage {
	msg := `{"action":"onCreditExchange","result":{"data":{"Balance":99949999.99,"BetBase":"1:1","Credit":100,"event":true},"event":true}}`
	return json.RawMessage(msg)
}

func (g FakePhpGame) OnBalanceExchange(uid UserID, hid HallID, gc GameCode) json.RawMessage {
...
func (g FakePhpGame) OnLeaveMachine(uid UserID, hid HallID, gameCode GameCode) json.RawMessage {
	panic("implement me")
}

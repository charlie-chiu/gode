...
func (g FakeGame5145) TakeMachine(uid UserID) json.RawMessage {
	r := &response{
...
func (g FakeGame5145) OnLoadInfo(uid UserID) json.RawMessage {
...
func (g FakeGame5145) GetMachineDetail(uid UserID) json.RawMessage {
	r := &response{
...
func (g FakeGame5145) BalanceExchange(uid UserID, hid HallID) json.RawMessage {
...
func (g FakeGame5145) LeaveMachine(uid UserID, hid HallID) json.RawMessage {
	panic("implement me")
}
